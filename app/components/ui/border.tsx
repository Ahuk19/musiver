...
export function HoverBorderGradientDemo({ icons, label }: { icons: any; label: string }) {
  return (
    <div className="flex flex-col justify-center text-center items-center gap-y-3">
      <HoverBorderGradient containerClassName="rounded-full" as="button" className="bg-black   items-center ">
        <span className="text-4xl md:text-7xl ">{icons}</span>
      </HoverBorderGradient>
